  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-12">
        <div className="mb-8 lg:mb-0 lg:hidden space-y-4">
          {settings.logo_url ? (
...
function FooterCol({ title, items }) {
  return (
    <div className="lg:col-span-2 space-y-2.5 sm:space-y-3 min-w-0">
      <h4 className="font-head text-white text-sm sm:text-base" style={{ fontWeight: 600 }}>{title}</h4>
      <ul className="space-y-1.5 sm:space-y-2.5">
        {items.map((it) => (
          <li key={it.label}>
            <Link
              to={it.to}
              className="font-body transition-colors hover:text-cyan-glow block text-[12px] sm:text-sm leading-snug"
...
function ContactCol() {
  return (
    <div className="lg:col-span-2 space-y-2.5 sm:space-y-3 min-w-0">
      <h4 className="font-head text-white text-sm sm:text-base" style={{ fontWeight: 600 }}>Contact</h4>
      <ul className="space-y-1.5 sm:space-y-2.5">
        <li>
          <a
            href="tel:01321642842"
            className="flex items-center gap-1.5 transition-colors hover:text-cyan-glow text-[12px] sm:text-sm leading-snug"
            style={{ color: '#A0AEC0' }}
          >
        ...
        <li>
          <a
            ...
            className="flex items-start gap-1.5 transition-colors hover:text-cyan-glow break-all text-[12px] sm:text-sm leading-snug"
            style={{ color: '#A0AEC0' }}
          >
      ...
      <div className="pt-2">
        <h4 className="font-head text-white mb-1.5 text-[12px] sm:text-sm" style={{ fontWeight: 600 }}>Payment</h4>
